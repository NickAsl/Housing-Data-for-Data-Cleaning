...
--C)Self-joining the table to find the above simularities and fill the nulls :
...
-- 2)BREAKING out Address into Indivitual Columns (Address,City,State)
...
-- Again here we are going to create 3 new columns to add the new owner's addresses into the table.
...
--3)Fixing the column SoldAsVacant. As we  can see below this column has ('N' , 'No' , 'Y' , 'Yes'). 
